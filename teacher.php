                ...
                <div class="Information-boxes p-20 bg-white rad-10 m-60">
                    <div class="content">
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr>";
                            echo "<td style='text-align: center;'>Teacher ID</td>";
                            ...
                            while ($teacher = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td style='text-align: center;'>" . $teacher['id'] . "</td>";
                                echo "<td style='text-align: center;'>" . $teacher['FirstLastname'] . "</td>";
                                echo "<td style='text-align: center;'>" . $teacher['Email'] . "</td>";
                                echo "<td style='text-align: center;'>" . $teacher['Rolle'] . "</td>";
                                echo "<td style='text-align: center;'> " . $teacher['Phone'] . "</td>";
                                echo "<td>";

                                echo '<button style="border: 1px solid grey;border-radius:0;width:150px;height:40px;margin: 5px;px;margin-left:100px;background-color:#399AFE;cursor:pointer;color:white;" class="modify-delete-button" onclick="location.href=\'modify_teacher.php?id=' . $teacher['id'] . '\'">Modify</button>';
                                echo '<button style="border: 1px solid grey;border-radius:0;width:150px;height:40px;background-color:crimson;color:white;cursor:pointer;margin-left:20px;" class="modify-delete-button" onclick="location.href=\'delete_teacher.php?id=' . $teacher['id'] . '\'">Delete</button>';
